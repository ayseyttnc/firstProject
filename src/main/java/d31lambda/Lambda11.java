...
*/
    ...
    public static int getSumFromSeventoSeventy(){
        ...
        return IntStream.rangeClosed(7,70).
                reduce(Math::addExact).// Integer class taki sum() da kullanabilirdik.ancak math olan daha gelismistir
                        //basit toplamlari islemleri icin sum.daha performans isleler icin math(overFlow kontrolu var.
                getAsInt();
    ...
    public static int getMultiplicationFromThreeToNine1(){
       ...
       // /multiplyExact - İki int veya long değerini çarpar. Math class’tadir.exact ile bitenlerde tasma kontrolu var math class tan gelir
...
//Negatif sayıların faktöriyeli yoktur
    ...
    public static int getFaktorial(int x){
        ...
        if (x==0){
            ...
            System.out.println("negatif sayilarin faktoryeli yoktur");
            return -1;
        }else {
            return IntStream.rangeClosed(1,x).reduce(Math:: multiplyExact).getAsInt();
        }
