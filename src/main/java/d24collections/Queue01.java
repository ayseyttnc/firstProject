...
//        queue nasil olusturulur?add ile queue ya eleman ekleriz
//        burda depo hep queue dur hem linklisttir .onemli olan turunun nasil davrandigidir
//        depo queue ara yuzunun bir ornegidir
//        link arayuzunden gelen methodlari dogrudan kullanamaz
//        refreansi queue veriyor
...
//        System.out.println(depo.element()); istisna hata exception
...
//Deque<String > d1=new ArrayDeque<>(); de yazabilirdik
...
//yeni satit=rlarda yazdirmak icin for each
d.addFirst("ali");
d.addLast("hasan");
        System.out.println(d);
        for (String w:d){
