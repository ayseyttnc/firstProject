...
project: Bilet Rezervasyon ve Bilet Fiyatı Hesaplama Uygulaması
    ...
    public static void main(String[] args) {
        ...
        //bilet rezervasyonu yapabilmek icin otobuse ihtiyacimiz var

        Bus bus=new Bus("80ab80");
        //3.bilet objesi olusturalim

        Ticket ticket=new Ticket();

//7.uygulamayi baslaytan
        start(bus,ticket);
    ...
    private static void start(Bus bus, Ticket ticket) {
        ...
        do {//kullanicidan bilgileri alalim
            ...
            System.out.println("tek yon");
            System.out.println("gidis-donus");

            int type= scan.nextInt();
            System.out.println("lutfen gidilecek mesafe bilgisin km olarak giriniz");
        double distance= scan.nextInt();

            System.out.println("lutfen koltk no seciniz");
...
//gririlen degerler gecerli mi
            if (age>0 && distance>0 || type==2&&!isReserved ) {
