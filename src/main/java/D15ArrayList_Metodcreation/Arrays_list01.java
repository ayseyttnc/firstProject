...
public class Arrays_list01 {
    public static void main(String[] args) {
        /*
    ArrayList,(classtir) dinamik bir array yapısıdır. Bu, ArrayList'in boyutunun, elemanlar ekleme veya çıkarma
