...
//        ogrenciNotlari.put(null,50); //exception firlatir
//        System.out.println(ogrenciNotlari); HATA
...
//        ogrenciNotlari.put("ahmet",null);  HATA
        ...
        stdAges.put(null,41);
        stdAges.put(null,39); //uzerine yazar.key bolumunde tek null kabul eder
        stdAges.put("a",null);
        stdAges.put("b",null); //value tarafinda sinirsiznull kabul ederr
        System.out.println(stdAges);// null kabul eder
...
Müşteri veya işlem sıralarını takip etmek için LinkedHashMap tercih edilebilir.*/
        ...
        for(Map.Entry<String,Integer>entry:lhm.entrySet()){
            System.out.println(entry.getKey()+"->"+ entry.getValue());// insertion order sirasi
